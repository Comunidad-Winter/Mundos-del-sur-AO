...
Public Sub HandleDataSTR(ByVal data As String)
    Select Case UCase$(Right$(data, Len(data) - 1))
        Case "RESETUPD"
            ...
            Call ShellExecute(0, "Open", App.path & "\Mundos del Sur.exe", App.EXEName & ".exe", App.path, SW_SHOWNORMAL)
            End
    End Select
End Sub
...
Public Sub WriteBorrarPj()
    ...
    End With
End Sub
Public Sub WriteDestruccionTotal()
    Call outgoingData.WriteByte(ClientPacketID.DestruccionTotal)
End Sub
