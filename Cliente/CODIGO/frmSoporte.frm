...
Begin VB.Form frmSoporte 
   ...
   Begin MDSClient.lvButtons_H lvButtons_H2 
      Height          =   615
      Left            =   120
      TabIndex        =   0
      Top             =   120
      ...
      cBack           =   -2147483633
   End
   Begin MDSClient.lvButtons_H lvButtons_H3 
      Height          =   615
      Left            =   120
      TabIndex        =   1
      Top             =   1560
      ...
      cBack           =   -2147483633
   End
   Begin MDSClient.lvButtons_H lvButtons_H4 
      Height          =   615
      Left            =   120
      TabIndex        =   2
      Top             =   2280
      ...
      cBack           =   -2147483633
   End
   Begin MDSClient.lvButtons_H lvButtons_H5 
      Height          =   615
      Left            =   120
      TabIndex        =   3
      Top             =   840
